...
import '../ListView/CustomInfiniteListView.dart';
...
class _NumberPickerState extends State<NumberPicker> with StyleMixin{
            ...
            _NumberPickerSelectedItemDecoration(
              ...
              decoration: widget.decoration?? BoxDecoration(
                  border: Border.symmetric(
                      horizontal: BorderSide(width: BorderWidthDimen.Basic.getSize()))),
            ),
          ],
        ),
      ),
  ...
  Widget _itemBuilder(BuildContext context, int index) {
    final defaultStyle = widget.textStyle ?? customTextStyle.basic(textColor: ColorConstants.LightText.color, textSize: TextDimen.VerySmall.getSize());
    final selectedStyle = widget.selectedTextStyle ??  customTextStyle.basic( textSize: TextDimen.Big.getSize());
