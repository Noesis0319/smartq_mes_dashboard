...
part '../Convert/PressMachineOrderSituationConvert.dart';

/// <summary>
/// 프레스설비 지시 현황
/// 프레스 설비 및 지시에 대한 현황정보 포함
/// </summary>

class PressMachineOrderSituationDto {
  /// <summary>
  /// 가동 상태
  /// </summary>
  ...
  /// 가동중인 지시라인
  /// </summary>
  List<PressMachineOrderSituationOrderLineDto>? _operatingOrderLines;

  PressMachineOrderSituationDto(
      this._runningStatus,
      this._machineId,
      this._machineCode,
      this._machineName,
  ...
  factory PressMachineOrderSituationDto.fromJson(Map<String, dynamic> json) =>
      _$PressMachineOrderSituationDtoFromJson(json);

  Map<String, dynamic> toJson() => _$PressMachineOrderSituationDtoToJson(this);

  List<PressMachineOrderSituationOrderLineDto>? get operatingOrderLines => _operatingOrderLines;
...
class PressMachineOrderSituationOrderLineDto {
  /// <summary>
  /// 라인ID
  /// </summary>
  int? _id;
  ...
  PressMachineOrderSituationOrderLineDto(
      this._id,
      this._orderId,
      this._itemId,
      this._itemCode,
  ...
  factory PressMachineOrderSituationOrderLineDto.fromJson(Map<String, dynamic> json) => _$OrderLineDtoFromJson(json);
