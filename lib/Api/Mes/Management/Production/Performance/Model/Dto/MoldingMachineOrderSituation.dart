...
part '../Convert/MoldingMachineOrderSituationConvert.dart';

/// <summary>
/// 설비지시현황.
/// 성형설비 및 성형지시에 대한 현황정보를 표현한다.
/// </summary>

class MoldingMachineOrderSituationDto {
  /// <summary>
  /// 가동 상태
  /// </summary>
  ...
  /// 가동중인 지시라인
  /// </summary>
  List<MoldingMachineOrderSituationOrderLineDto>? _operatingOrderLines;


  MoldingMachineOrderSituationDto(
      this._runningStatus,
      this._machineId,
      this._machineCode,
      this._machineName,
  ...
  factory MoldingMachineOrderSituationDto.fromJson(Map<String, dynamic> json) =>
      _$MoldingMachineOrderSituationDtoFromJson(json);

  Map<String, dynamic> toJson() => _$MoldingMachineOrderSituationDtoToJson(this);

  List<MoldingMachineOrderSituationOrderLineDto>? get operatingOrderLines => _operatingOrderLines;
...
class MoldingMachineOrderSituationOrderLineDto {
  /// <summary>
  /// 라인ID
  /// </summary>
  int? _id;
  ...
  MoldingMachineOrderSituationOrderLineDto(
      this._id,
      this._orderId,
      this._itemId,
      this._itemCode,
  ...
  factory MoldingMachineOrderSituationOrderLineDto.fromJson(Map<String, dynamic> json) => _$OrderLineDtoFromJson(json);
