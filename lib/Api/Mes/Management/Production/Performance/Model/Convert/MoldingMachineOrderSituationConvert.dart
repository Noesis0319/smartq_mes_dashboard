...
part of '../Dto/MoldingMachineOrderSituation.dart';

MoldingMachineOrderSituationDto _$MoldingMachineOrderSituationDtoFromJson(
    ...
    MoldingMachineOrderSituationDto(
      ...
      (json[ApiJsonKey.OperatingOrderLines.key] as List<dynamic>?)
          ?.map((e) => MoldingMachineOrderSituationOrderLineDto.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$MoldingMachineOrderSituationDtoToJson(
    MoldingMachineOrderSituationDto instance) {
...
MoldingMachineOrderSituationOrderLineDto _$OrderLineDtoFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$OrderLineDtoToJson(MoldingMachineOrderSituationOrderLineDto instance) {
  final val = <String, dynamic>{};
