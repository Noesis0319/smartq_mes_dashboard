...
part of '../Dto/PressMachineOrderSituation.dart';

PressMachineOrderSituationDto _$PressMachineOrderSituationDtoFromJson(
    ...
    PressMachineOrderSituationDto(
      ...
      (json[ApiJsonKey.OperatingOrderLines.key] as List<dynamic>?)
          ?.map((e) => PressMachineOrderSituationOrderLineDto.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$PressMachineOrderSituationDtoToJson(
    PressMachineOrderSituationDto instance) {
...
PressMachineOrderSituationOrderLineDto _$OrderLineDtoFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$OrderLineDtoToJson(PressMachineOrderSituationOrderLineDto instance) {
  final val = <String, dynamic>{};
